...
//	public static void main(String[] args) throws InterruptedException {
	...
	public void Login() throws InterruptedException {
		...
		sendkeys(pom.getreportnega().getUsername(), "Admin3");
	...
	public void Paymentanalysis() throws InterruptedException {
		...
		// cli pat
		selectone(pom.getreportnega().getseleoff(), "John Hospital");
	...
	public void Productandprocedure() throws InterruptedException {
		...
		sendkeys(pom.getreportnega().getcodese(), "a");
	...
	public void PatientReport() throws InterruptedException {
		...
		Clickonelement(pom.getreportnega().getmedse());
	...
	public void TelehealthReport() throws InterruptedException {
		...
		// sele pat
		sendkeys(pom.getreportnega().getstarda(), "05/09/2022");

		// sele pat
		sendkeys(pom.getreportnega().getendda(), "05/31/2022");
...
//		Clickonelement(pom.getreportnega().getuserre());
		...
		// use pat
		sendkeys(pom.getreportnega().getserus(), "Tester");
